...
(filter_input(INPUT_GET, "id")) ? $id = filter_input(INPUT_GET, "id") : $id = null;
$db = new Database;
...
<section class="category container">
      <div class="cat-box">
            ...
            while ($cat = $resultt->fetch_assoc()) :
                ...
                if (isset($_GET['info'])) :
            ?>
            <li> <a href="drug-info.php">no SubCategory , return back</a></li>
                    <?php else : ?>
                 <li> <a href="shop.php">no SubCategory , return to shop</a></li>
                   <?php endif; ?>
                <?php else :
                    if (isset($_GET['info'])) :
                ?>
...
<?php endwhile; ?>
            ...
            <section class="continue-shopping container">
                    ...
                    <?php if (isset($_GET['info'])) : ?>
                     <a href="drug-info.php">Return Back</a>
            <?php else : ?>
